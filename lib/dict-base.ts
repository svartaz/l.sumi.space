...
export const dictBase: Dict = newMap([
  ...
  // case marker
  ['_n', { signifier: 'z', klass: 'case', signifiee: '主格', attribute: [], etymology: { gem: '-az' } }],
  ['_a', { signifier: 'n', klass: 'case', signifiee: '對格', attribute: [], etymology: { gem: '-ą' } }],
  ['_d', { signifier: 't', klass: 'case', signifiee: '與格', attribute: [], etymology: { gem: 'ta' } }],

  ['of', { signifier: 'f', klass: '', signifiee: '', attribute: [], etymology: { de: 'von' } }],
  ['with', { signifier: 'q', klass: '', signifiee: '', attribute: [], etymology: {} }],
  ['_swap', { signifier: 'CV', klass: 'case', signifiee: '', attribute: [], etymology: {} }],

  ['then', { signifier: 'd', klass: 'case', signifiee: '', attribute: [], etymology: { gem: 'þan' } }],

  // pronoun
  ['i', { signifier: 'vi', klass: 'verb', signifiee: 'Aは我', attribute: [], etymology: { gem: 'wīz' } }],
  ['thou', { signifier: 'ju', klass: 'verb', signifiee: 'Aは汝', attribute: [], etymology: { gem: 'jūz' } }],
  ['he', { signifier: 'sa', klass: 'verb', signifiee: 'Aは彼', attribute: [], etymology: { gem: 'sa' } }],
  ['self', { signifier: 'si', klass: 'verb', signifiee: 'Aは自身 (既に文に登場した對稱)', attribute: [], etymology: { gem: 'sīnaz' } }],

  // subordinate
  ['what', { signifier: 'xvaz', klass: '', signifiee: 'Aは誰', attribute: [], etymology: { gem: 'hwaz' } }],
  ...
  // mood
  ['may', { signifier: 'mac', klass: 'adverb', signifiee: '', attribute: [], etymology: { gem: 'maganą' } }],
  ...
  ['_frequent', { signifier: 'mel', klass: 'verb/number/verb', signifiee: '0: never. high: often. max: always.', attribute: [], etymology: { gem: 'mēlą' } }],
  ...
  ['six', { signifier: 'se', klass: 'numeral', signifiee: '6', attribute: [], etymology: { gem: 'sehs' } }],
  ['seven', { signifier: 'za', klass: 'numeral', signifiee: '7', attribute: [], etymology: { sa: 'sapta' } }],
  ...
  ['null', { signifier: 'lez', klass: 'numeral', signifiee: 'null', attribute: [], etymology: { gem: 'lēziz' } }],
  ['min', { signifier: 'min', klass: 'numeral', signifiee: 'minimum', attribute: [], etymology: { la: 'minimus' } }],
  ['max', { signifier: 'can', klass: 'numeral', signifiee: 'maximum, every', attribute: [], etymology: { gmw: 'gant' } }],

  ['less', { signifier: 'les', klass: 'numeral', signifiee: '≤', attribute: [], etymology: { en: 'less' } }],

  ['low', { signifier: 'loc', klass: 'numeral', signifiee: '', attribute: [], etymology: { gem: 'lēgaz' } }],
  ['normal', { signifier: 'norm', klass: 'numeral', signifiee: '', attribute: [], etymology: { en: 'norm' } }],
  ['high', { signifier: 'xox', klass: 'numeral', signifiee: '', attribute: [], etymology: { de: 'hoch' } }],
  ...
  ['not', { signifier: 'no', klass: '', signifiee: '', attribute: [], etymology: { and: '' } }],
  ['and', { signifier: 'an', klass: '', signifiee: '', attribute: [], etymology: { and: 'andi' } }],
  ['or', { signifier: 'ef', klass: '', signifiee: '', attribute: [], etymology: { gem: 'efþau' } }],
  ['iff', { signifier: 'xvan', klass: '', signifiee: '', attribute: [], etymology: { gem: 'hwan' } }],
  ...
  ['spin', { signifier: 'spin', klass: 'verb', signifiee: 'AはBを回轉する', attribute: [], etymology: { gem: 'spinnaną' } }],
  ...
  ['laugh', { signifier: 'xlax', klass: 'verb', signifiee: 'Aは笑ふ', attribute: [], etymology: { gem: 'hlahjaną' } }],
  ...
  ['excrete', { signifier: 'sqit', klass: 'verb', signifiee: 'AはBを排泄する', attribute: [], etymology: { gem: 'skitiz' } }],
  ...
  ['see', { signifier: 'sexv', klass: 'verb', signifiee: 'AはBを見る', attribute: [], etymology: { gem: 'sehwaną' } }],
  ...
  ['wait', { signifier: 'vard', klass: 'verb', signifiee: 'AはBを豫期する.', attribute: [], etymology: { gem: 'wardāną' } }],
  ...
  ['differ', { signifier: 'and', klass: 'verb', signifiee: 'AはBと異なる', attribute: [], etymology: { gem: 'anþeraz' } }],
  ['vary', { signifier: 'mut', klass: 'verb', signifiee: 'AはBへ變化する', attribute: [], etymology: { la: 'mūtāre' } }],

  // transitive
  ['make', { signifier: 'vurq', klass: 'verb', signifiee: 'AはBをCに變へる, BからCを作る', attribute: [], etymology: { gem: 'wurkijaną' } }],
  ...
  ['declare', { signifier: 'qund', klass: 'verb', signifiee: 'AはBを宣言する', attribute: [], etymology: { gem: 'kunþijaną' } }],
  ...
  // activity
  ['greet', { signifier: 'salut', klass: 'verb', signifiee: 'AはBに挨拶する', attribute: [], etymology: { la: 'salūs, salūtis' } }],
  ['fight', { signifier: 'fext', klass: 'verb', signifiee: 'AはBに抗ふ', attribute: [], etymology: { gem: 'fehtaną' } }],

  ['play', { signifier: 'spil', klass: 'verb', signifiee: 'AはBを遊ぶ', attribute: [], etymology: { gem: 'spil' } }],
  ...
  ['imitate', { signifier: 'CVC', klass: 'verb', signifiee: 'S imitate O', attribute: [], etymology: { gem: 'imitārī' } }],
  ...
  ['flesh', { signifier: 'flesq', klass: 'verb', signifiee: 'AはBの肉である', attribute: [], etymology: { gem: 'flaiski' } }],
  ...
  ['vagina', { signifier: 'sqed', klass: 'verb', signifiee: 'AはBの腟である', attribute: [], etymology: { gem: 'skaiþiz' } }],
