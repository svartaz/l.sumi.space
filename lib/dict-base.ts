...
export const dictBase = {
  ...
  solid: { signifier: 'CVCV', category: 'physics/state', klass: 'verb', signifiee: 'S is solid', version: 0, etymology: '' },
  liquid: { signifier: 'CVCV', category: 'physics/state', klass: 'verb', signifiee: 'S is liquid', version: 0, etymology: '' },
  gas: { signifier: 'CVCV', category: 'physics/state', klass: 'verb', signifiee: 'S is gas', version: 0, etymology: '' },
  plasma: { signifier: 'CVCV', category: 'physics/state', klass: 'verb', signifiee: 'S is plasma', version: 0, etymology: '' },

  water: { signifier: ja('みづ').substring(0, 3) + 'V', category: 'chemistry', klass: 'verb', signifiee: 'S is water', version: 0, etymology: '' },
  salt: { signifier: ja('しを').substring(0, 3) + 'V', category: 'chemistry', klass: 'verb', signifiee: 'Aはsalt', version: 0, etymology: '' },
  oil: { signifier: ja('あぶら').substring(0, 3) + 'V', category: 'chemistry', klass: 'verb', signifiee: 'S is oil (fat)', version: 0, etymology: '' },
  metal: { signifier: ja('かね').substring(0, 3) + 'V', category: 'chemistry', klass: 'verb', signifiee: 'S is metal', version: 0, etymology: '' },
  ...
  celestial: { signifier: ja('ほし').substring(0, 3) + 'V', category: 'space', klass: 'verb', signifiee: 'S is astral body', version: 0, etymology: '' },
  star: { signifier: 'CVCV', category: 'space', klass: 'verb', signifiee: 'S is star', version: 0, etymology: 'Ja ひ' },
  planet: { signifier: 'CVCV', category: 'space', klass: 'verb', signifiee: 'S is planet', version: 0, etymology: '' },
  satellite: { signifier: ja('つき').substring(0, 3) + 'V', category: 'space', klass: 'verb', signifiee: 'S is satellite', version: 0, etymology: '' },
  ...
  happy: { signifier: ja('うれしむ').substring(0, 3) + 'V', category: 'emotion', klass: 'verb', signifiee: 'S is happy with O.', version: 0, etymology: '' },
  ...
  true: { signifier: ja('まこと').substring(0, 3) + 'V', category: 'language', klass: 'verb', signifiee: 'S is true', version: 0, etymology: '' },
  speak: { signifier: ja('いふ').substring(0, 3) + 'V', category: 'language', klass: 'verb', signifiee: 'S say O', version: 0, etymology: '' },
  write: { signifier: ja('かく').substring(0, 3) + 'V', category: 'language', klass: 'verb', signifiee: 'S write O', version: 0, etymology: '' },
  mean: { signifier: 'CVCV', category: 'language', klass: 'verb', signifiee: 'S means O', version: 0, etymology: '' },

  declare: { signifier: ja('のる').substring(0, 3) + 'V', category: 'activity', klass: 'verb', signifiee: 'S declare O', version: 0, etymology: '宣る' },
  ask: { signifier: ja('とふ').substring(0, 3) + 'V', category: 'activity', klass: 'verb', signifiee: 'S ask O', version: 0, etymology: '' },
  apologise: { signifier: 'CVCV', category: 'activity', klass: 'verb', signifiee: 'S apologise for O', version: 0, etymology: '' },
  appreciate: { signifier: 'CVCV', category: 'activity', klass: 'verb', signifiee: 'S appreciate O', version: 0, etymology: '' },
  forgive: { signifier: ja('ゆるす').substring(0, 3) + 'V', category: 'activity', klass: 'verb', signifiee: 'S forgive O', version: 0, etymology: '' },
  deceive: { signifier: ja('だます').substring(0, 3) + 'V', category: 'activity', klass: 'verb', signifiee: 'S deceive O', version: 0, etymology: '' },

  greet: { signifier: 'CVCV', category: 'activity', klass: 'verb', signifiee: 'S greet to O', version: 0, etymology: '' },
  fight: { signifier: 'CVCV', category: 'activity', klass: 'verb', signifiee: 'S fight against O', version: 0, etymology: '' },
