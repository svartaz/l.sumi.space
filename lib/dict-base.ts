...
export const dictBase = {
  ...
  he: { name: 'se', category: 'pronoun', type: '* number: noun', named: 'he', version: 0, etymology: '' },
  ...
  what: { name: 'qi', category: '', type: '', named: '', version: 0, etymology: 'Lat quis' },
  that: { name: 'sa', category: '', type: '', named: '', version: 0, etymology: 'Proto-Germanic þat' },
  ...
  less: { name: 'CV', category: 'number/relation', type: 'numeral', named: '<', version: 0, etymology: '' },
  ...
  have: { name: 'xa', category: '', type: 'noun', named: 'S have O', version: 0, etymology: 'Lat habere' },
  ...
  hair: { name: 'kapV', category: 'body/head', type: 'noun', named: 'S have hair O', version: 0, etymology: 'Lat capillī' },
  brain: { name: 'kelV', category: 'body/head', type: 'noun', named: 'S have brain O', version: 0, etymology: 'Lat cerebrī' },
  eye: { name: 'hokV', category: 'body/head', type: 'noun', named: 'S have eye O', version: 0, etymology: 'Lat oculī' },
  ear: { name: 'havV', category: 'body/head', type: 'noun', named: 'S have ear O', version: 0, etymology: 'Lat auris' },
  nose: { name: 'nasV', category: 'body/head', type: 'noun', named: 'S have nose O', version: 0, etymology: 'Lat nāsī' },
  mouth: { name: 'hølV', category: 'body/head', type: 'noun', named: 'S have mouth O', version: 0, etymology: 'Lat ōris' },
  tooth: { name: 'denV', category: 'body/head', type: 'noun', named: 'S have tooth O', version: 0, etymology: 'Lat dentis' },
  tongue: { name: 'dinV', category: 'body/head', type: 'noun', named: 'S have tongue O', version: 0, etymology: 'Lat dinguae' },
  throat: { name: 'favV', category: 'body/head', type: 'noun', named: 'S have throat O', version: 0, etymology: 'Lat faucium' },

  horn: { name: 'kolV', category: 'body/head', type: 'noun', named: 'S have horn O', version: 0, etymology: 'Lat cornūs' },

  heart: { name: 'kolV', category: 'body/organ', type: 'noun', named: 'S have heart O', version: 0, etymology: 'Lat cordis' },
  lung: { name: 'pulV', category: 'body/organ', type: 'noun', named: 'S have lung O', version: 0, etymology: 'Lat pulmonis' },
  gut: { name: 'venV', category: 'body/organ', type: 'noun', named: 'S have gut O', version: 0, etymology: 'Lat ventris' },
  ...
  limb: { name: 'memV', category: 'body/limb', type: 'noun', named: 'S have limb or branch or wing O', version: 0, etymology: 'Lat membrī' },
  hand: { name: 'manV', category: 'body/limb', type: 'noun', named: 'S have hand or foot O', version: 0, etymology: 'Lat manūs' },
  finger: { name: 'dicV', category: 'body/limb', type: 'noun', named: 'S have finger O', version: 0, etymology: 'Lat digitī' },
  nail: { name: 'nucV', category: 'body/limb', type: 'noun', named: 'S have nail O', version: 0, etymology: 'Lat unguis' },

  nerve: { name: 'nelV', category: 'body/whole', type: 'noun', named: 'S have nerve O', version: 0, etymology: 'Lat nervī' },
  muscle: { name: 'mysV', category: 'body/whole', type: 'noun', named: 'S have flesh O', version: 0, etymology: 'Lat mūsculī' },
  bone: { name: 'høsV', category: 'body/whole', type: 'noun', named: 'S have bone O', version: 0, etymology: 'Lat ōris' },
  skin: { name: 'pelV', category: 'body/whole', type: 'noun', named: 'S have skin O', version: 0, etymology: 'Lat pellis' },

  fruit: { name: 'fylV', category: 'body/plant', type: 'noun', named: 'S have fruit O', version: 0, etymology: 'Lat frūctūs' },
  root: { name: 'ladV', category: 'body/plant', type: 'noun', named: 'S have root O', version: 0, etymology: 'Lat rādīcis' },
  ...
  sense: { name: 'senV', category: 'sansation', type: 'noun', named: 'S feel O', version: 0, etymology: 'Lat sentīre' },
  hear: { name: 'havV', category: 'sansation', type: 'noun', named: 'S hear O', version: 0, etymology: 'Lat audīre' },
  see: { name: 'vidV', category: 'sansation', type: 'noun', named: 'S see O', version: 0, etymology: 'Lat vidēre' },
  taste: { name: 'cusV', category: 'sansation', type: 'noun', named: 'S taste O', version: 0, etymology: 'Lat gustāre' },
  smell: { name: 'holhV', category: 'sansation', type: 'noun', named: 'S smell O', version: 0, etymology: 'Lat olēre' },
  touch: { name: 'tanV', category: 'sansation', type: 'noun', named: 'S feel touch of O', version: 0, etymology: 'Lat tangere' },
  hurt: { name: 'ledV', category: 'sansation', type: 'noun', named: 'S is hurt by O', version: 0, etymology: 'Lat laedere' },

  smile: { name: 'simV', category: 'facial', type: 'noun', named: 'S smile', version: 0, etymology: 'Proto-Germanic smīlijaną' },
  laugh: { name: 'lahV', category: 'facial', type: 'noun', named: 'S laugh', version: 0, etymology: 'Proto-Germanic hlahjaną' },
  frown: { name: 'locV', category: 'facial', type: 'noun', named: 'S frown', version: 0, etymology: 'Proto-Celtic srognā' },
  cry: { name: 'sabV', category: 'facial', type: 'noun', named: 'S cry', version: 0, etymology: 'Middle-Low-German sabben' },

  want: { name: 'CVCV', category: 'emotion', type: 'noun', named: 'S want O', version: 0, etymology: '' },
  ...
  think: { name: 'sekV', category: 'intellectual', type: 'noun', named: 'S think O', version: 0, etymology: 'Grc σκέπτομαι' },
  know: { name: 'dVnV', category: 'intellectual', type: 'noun', named: 'S know O', version: 0, etymology: 'Grc γνωρίζω' },
